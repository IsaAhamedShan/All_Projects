...
<head>
	<title>Safe Deposit Tracking System | Home</title>
...
<body>
	...
	<div class="col-md-6 col-sm-6 agileinfo_mail_grid_right " style="margin-bottom: 30px;">
	...
	<div class="about" id="about">
		<div class="container">
			<h3 class="w3l-title"><span>About Us</span> </h3>
			<div class="w3-agileits-about-grids">
				...
				<div class="col-md-7 agile-about-left">
					...
					?>
						<h3 class="w3l-sub">We have Best to Offer</h3>
						<p class="sub-p">Best rates and fees</p>
	...
	<div class="mail" id="contact">
		<div class="container">
			<h3 class="w3l-title"><span>Contact Us</span> </h3>
